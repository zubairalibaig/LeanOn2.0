...
const faqSchema = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
  ...
  { '@type': 'Question', name: 'How much does it cost to talk to an NRI online?', acceptedAnswer: { '@type': 'Answer', text: 'First 5 minutes are always free. Sessions continue from ₹160 for 15 minutes. No subscription, no commitment.' } },
] }
