  ...
  return (
    <>
      ...
      <div className="page">
        ...
        <div className="section">
          <h2>Earnings</h2>
          <p>At ₹10/min, a single 30-minute session earns ₹255 after LeanOn&apos;s 15% service fee. Three sessions a day is ~₹765 — roughly ₹23,000/month, around your existing schedule. Experienced listeners charge ₹20–25/min, earning ₹510+ per session.</p>
          <p>Payouts are processed via UPI within 3 business days. You keep 85% of every rupee you charge.</p>
        </div>
