    ...
    <>
      ...
      <div className="page">
        ...
        <div className="section">
          ...
          <p>The Indian family who has been in Calgary for eight years and still feels like they are watching the city from the outside. The Indian professional whose colleagues are warm and welcoming and with whom they share almost nothing cultural. The way you get invited to Stampede parties every year and go and enjoy it and come home feeling somehow more aware of what you are not. LeanOn is the space to talk about this without having to explain it. Real Indian listener, anonymous, no appointment needed. From ₹160.</p>
        </div>

        <div className="section"><h2>Frequently Asked Questions</h2>{faqs.map((f, i) => (<div className="faq-item" key={i}><p className="faq-q">{f.name}</p><p className="faq-a">{f.acceptedAnswer.text}</p></div>))}</div>
        <div className="cta-card"><h2>Alberta is home now. Talk to someone who understands what that means.</h2><p>Real Indian peer listener. Understands the Calgary Indian experience. Anonymous. First 5 minutes free. From ₹160.</p><a href="https://www.leanon.app/browse" className="btn-cta">Find a listener &rarr;</a></div>
