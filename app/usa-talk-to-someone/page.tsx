...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Sessions are $10 for 15 minutes, $15 for 30 minutes, and $20 for 45 minutes. Your first 5 minutes are always free. Compared to $200/hour therapy, it is genuinely accessible.',
      },
    },
    {
      '@type': 'Question',
    ...
    <>
      ...
      <div className="page">
        ...
        <div className="card">
          ...
          <p>Your first 5 minutes are always free. No insurance required. No referral needed. No waitlist.
