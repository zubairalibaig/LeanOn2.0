...
const faqSchema = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
  ...
  { '@type': 'Question', name: 'How much does it cost?', acceptedAnswer: { '@type': 'Answer', text: 'First 5 minutes free every session. Sessions from ₹160 for 15 minutes. No subscription, no commitment.' } },
] }
    ...
    <>
      ...
      <div className="page">
        ...
        <div className="section">
          ...
          <p>Sessions are text-based, anonymous, and completely private. Nothing reaches your team, your H-1B sponsor, or your family back in India. The first 5 minutes are always free.</p>
        </div>
