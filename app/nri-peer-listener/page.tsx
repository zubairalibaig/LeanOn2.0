...
const faqSchema = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
  ...
  { '@type': 'Question', name: 'How much does a session with an NRI peer listener cost?', acceptedAnswer: { '@type': 'Answer', text: 'First 5 minutes are free every session. Sessions continue from ₹160 for 15 minutes. No subscription.' } },
] }
