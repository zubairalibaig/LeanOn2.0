  ...
  return (
    <>
      ...
      <div className="page">
        ...
        <div className="cta-card"><h2>The city built by your community. A space that&rsquo;s just for you.</h2><p>Real Indian peer listener. Understands Leicester Indian community history and pressures. First 5 minutes free. From ₹160.</p><a href="/browse" className="btn-cta">Find a listener &rarr;</a></div>
