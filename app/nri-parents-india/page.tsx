...
const faqSchema = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
  ...
  { '@type': 'Question', name: 'How much does a session cost?', acceptedAnswer: { '@type': 'Answer', text: 'First 5 minutes free every session. Sessions from ₹160 for 15 minutes. No subscription required.' } },
] }
