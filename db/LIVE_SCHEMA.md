...
| 🟡 MED | `messages` has two INSERT policies: `messages_insert` and `messages_participant_insert` — both allow sender to insert into their sessions; harmless | migrations | Cosmetic |
