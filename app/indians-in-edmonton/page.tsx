...
const faqSchema = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
  ...
  { '@type': 'Question', name: 'How much does a session cost?', acceptedAnswer: { '@type': 'Answer', text: 'First 5 minutes are free every session. Sessions from ₹160 for 15 minutes. No subscription required.' } },
    ...
    <>
      ...
      <div className="page">
        ...
        <div className="section">
          ...
          <p>LeanOn listeners understand the Edmonton Indian experience. First 5 minutes free, from ₹160.</p>
        </div>
