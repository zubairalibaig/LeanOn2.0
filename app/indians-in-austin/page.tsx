  ...
  return (
    <>
      ...
      <div className="page">
        ...
        <div className="cta-card"><h2>Austin is booming. You should be able to say when you&rsquo;re not.</h2><p>Real Indian peer listener. Understands the Austin Indian transplant experience. Anonymous. First 5 minutes free. From US$10.</p><a href="https://www.leanon.app/browse" className="btn-cta">Find a listener &rarr;</a></div>
