  ...
  return (
    <>
      ...
      <div className="page">
        ...
        <div className="cta-card"><h2>Before your Phoenix community forms.</h2><p>Real Indian peer listener. Understands the new arrival NRI experience. First 5 minutes free. From ₹160.</p><a href="/browse" className="btn-cta">Find a listener &rarr;</a></div>
