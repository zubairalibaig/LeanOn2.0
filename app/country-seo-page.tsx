...
export default function CountrySeoPage({ data }: { data: CountrySeoData }) {
  ...
  const aiPage = data.slug === 'india' ? '/ai-chatbot-alternative' : `/ai-chatbot-alternative-${data.slug}`
  const jsonLd = {
