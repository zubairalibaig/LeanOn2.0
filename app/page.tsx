      ...
      <div className="inner" style={{paddingBottom:0}}>
        <div className="faq-section">
          ...
          {[
            ...
            { q: 'How does pricing work?', a: 'LeanOn charges a flat fee per session. 15-minute sessions start at ₹160. Your first session is free (5 minutes) — no wallet top-up needed. After that, sessions cost the per-minute rate set by the listener plus a ₹10 platform fee, in 15, 30 or 45-minute sessions. Outside India, sessions are a flat US$10 for 15 minutes.' },
