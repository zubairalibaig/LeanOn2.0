...
export const metadata: Metadata = {
  ...
  keywords: ['peer support India', 'emotional support app India', 'talk to someone online India', 'mental health peer support', 'online listener India', 'emotional wellness app'],
  authors: [{ name: 'LeanOn' }],
  creator: 'LeanOn',
  publisher: 'LeanOn',
