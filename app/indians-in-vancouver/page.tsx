  ...
  return (
    <>
      ...
      <div className="page">
        ...
        <div className="cta-card"><h2>Beautiful BC. Real support behind it.</h2><p>Real Indian peer listener. Understands BC Punjabi and Indian community life. First 5 minutes free. From ₹160.</p><a href="/browse" className="btn-cta">Find a listener &rarr;</a></div>
